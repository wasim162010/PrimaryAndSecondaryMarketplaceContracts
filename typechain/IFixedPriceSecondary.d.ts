...
interface IFixedPriceSecondaryInterface extends ethers.utils.Interface {
  functions: {
...
export class IFixedPriceSecondary extends BaseContract {
  ...
  interface: IFixedPriceSecondaryInterface;
