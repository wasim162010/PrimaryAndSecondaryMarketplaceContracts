...
interface SecondaryMarketplaceInterface extends ethers.utils.Interface {
  functions: {
    ...
    "listItemFixedPrice(address,uint96,uint128,uint128,uint8,bytes)": FunctionFragment;
  ...
  events: {
    ...
    "BoughtFixedPrice(uint256,uint256,address)": EventFragment;
...
export class SecondaryMarketplace extends BaseContract {
  ...
  interface: SecondaryMarketplaceInterface;
  ...
  functions: {
    ...
    getAuctionItem(
      ...
      [string, BigNumber, BigNumber, BigNumber, string, number, number] & {
        asset: string;
    ...
    getOfferItem(
      ...
      [string, BigNumber, BigNumber, string, number, number] & {
        asset: string;
        tokenId: BigNumber;
        amount: BigNumber;
        seller: string;
  ...
  filters: {
    ...
    "BoughtFixedPrice(uint256,uint256,address)"(
      fixedItemId?: BigNumberish | null,
      tokenId?: BigNumberish | null,
      buyer?: null
    ): TypedEventFilter<
      [BigNumber, BigNumber, string],
      { fixedItemId: BigNumber; tokenId: BigNumber; buyer: string }
    >;
